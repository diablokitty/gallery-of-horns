...
class Main extends React.Component{
  ...
  render() {
    return <main>
    <HornedBeast name = "Goat" picture = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Hausziege_04.jpg/330px-Hausziege_04.jpg" alttxt="Goat" titletxt="Gooooat!" text = "This is a stolen goat."/>
